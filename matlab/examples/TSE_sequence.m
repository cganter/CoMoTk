%% TSE sequence
% This script compares an idealized versus realistic implementation of a TSE sequence
...
m_ideal = zeros( num_echos, num_cycles );
m_real = zeros( num_echos, num_cycles );
